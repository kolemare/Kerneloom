...
namespace
{
        ...
        double absolute_tolerance)
    {
        ...
        const std::size_t output_plane_size =
            output_height * output_width;

        const std::size_t output_total =
            batch_size * channels * output_plane_size;
             ...
             ++output_index)
        {
            ...
            const std::size_t c =
                (output_index / output_plane_size) % channels;
        ...
        std::size_t padding_width)
    {
        ...
        kl::maxpool2d_with_indices_rocm_float32(
            input,
            actual,
            indices,
            pooling_options);
...
TEST(MaxPool2dWithIndicesForwardRocmFloat32, MatchesMIOpen_RegularLarge)
{
    runCorrectness(
...
TEST(MaxPool2dWithIndicesForwardRocmFloat32, MatchesMIOpen_DemandingOddShape)
{
    runCorrectness(
...
TEST(MaxPool2dWithIndicesForwardRocmFloat32, MatchesMIOpen_PaddedStrideOne)
{
    runCorrectness(
...
TEST(MaxPool2dWithIndicesForwardRocmFloat32, MatchesMIOpen_PaddedStrideTwo)
{
    runCorrectness(
...
TEST(MaxPool2dWithIndicesForwardRocmFloat32, BenchmarkAgainstMIOpen_RegularLarge)
{
    runBenchmark(
        "MaxPool2d With Indices Forward ROCm Float32 Regular Large",
        options::regular_large::batch_size,
        options::regular_large::channels,
        options::regular_large::input_height,
        options::regular_large::input_width,
...
TEST(MaxPool2dWithIndicesForwardRocmFloat32, BenchmarkAgainstMIOpen_DemandingOddShape)
{
    runBenchmark(
        "MaxPool2d With Indices Forward ROCm Float32 Demanding Odd Shape",
        options::demanding_odd_shape::batch_size,
        options::demanding_odd_shape::channels,
        options::demanding_odd_shape::input_height,
        options::demanding_odd_shape::input_width,
...
TEST(MaxPool2dWithIndicesForwardRocmFloat32, BenchmarkAgainstMIOpen_PaddedStrideOne)
{
    runBenchmark(
        "MaxPool2d With Indices Forward ROCm Float32 Padded Stride One",
        options::padded_stride_one::batch_size,
        options::padded_stride_one::channels,
        options::padded_stride_one::input_height,
        options::padded_stride_one::input_width,
...
TEST(MaxPool2dWithIndicesForwardRocmFloat32, BenchmarkAgainstMIOpen_PaddedStrideTwo)
{
    runBenchmark(
        "MaxPool2d With Indices Forward ROCm Float32 Padded Stride Two",
        options::padded_stride_two::batch_size,
        options::padded_stride_two::channels,
        options::padded_stride_two::input_height,
        options::padded_stride_two::input_width,
