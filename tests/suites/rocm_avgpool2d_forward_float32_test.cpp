...
#include "vendor/rocm/miopen_avgpool2d.hiph"
...
namespace
{
        ...
        std::size_t padding_width)
    {
        ...
        kl::avgpool2d_rocm_float32(
            input,
            actual,
            pooling_options);

        const auto expected =
            kl::test::miopenAvgPool2dForwardFloat32(
                input,
                kernel_height,
                kernel_width,
                padding_height,
        ...
        std::size_t padding_width)
    {
        ...
        kl::test::MiopenAveragePoolingDescriptor miopen_pooling_descriptor(
            kernel_height,
            kernel_width,
            padding_height,
            padding_width,
...
TEST(AvgPool2dForwardRocmFloat32, MatchesMIOpen_RegularLarge)
{
    runCorrectness(
...
TEST(AvgPool2dForwardRocmFloat32, MatchesMIOpen_DemandingOddShape)
{
    runCorrectness(
...
TEST(AvgPool2dForwardRocmFloat32, MatchesMIOpen_PaddedStrideOne)
{
    runCorrectness(
...
TEST(AvgPool2dForwardRocmFloat32, MatchesMIOpen_PaddedStrideTwo)
{
    runCorrectness(
...
TEST(AvgPool2dForwardRocmFloat32, BenchmarkAgainstMIOpen_RegularLarge)
{
    runBenchmark(
        "AvgPool2d Forward ROCm Float32 Regular Large",
        options::regular_large::batch_size,
        options::regular_large::channels,
        options::regular_large::input_height,
        options::regular_large::input_width,
...
TEST(AvgPool2dForwardRocmFloat32, BenchmarkAgainstMIOpen_DemandingOddShape)
{
    runBenchmark(
        "AvgPool2d Forward ROCm Float32 Demanding Odd Shape",
        options::demanding_odd_shape::batch_size,
        options::demanding_odd_shape::channels,
        options::demanding_odd_shape::input_height,
        options::demanding_odd_shape::input_width,
...
TEST(AvgPool2dForwardRocmFloat32, BenchmarkAgainstMIOpen_PaddedStrideOne)
{
    runBenchmark(
        "AvgPool2d Forward ROCm Float32 Padded Stride One",
        options::padded_stride_one::batch_size,
        options::padded_stride_one::channels,
        options::padded_stride_one::input_height,
        options::padded_stride_one::input_width,
...
TEST(AvgPool2dForwardRocmFloat32, BenchmarkAgainstMIOpen_PaddedStrideTwo)
{
    runBenchmark(
        "AvgPool2d Forward ROCm Float32 Padded Stride Two",
        options::padded_stride_two::batch_size,
        options::padded_stride_two::channels,
        options::padded_stride_two::input_height,
        options::padded_stride_two::input_width,
