...
TEST(MaxPool2dForwardCudaFloat32, MatchesCuDNN_RegularLarge)
{
    runCorrectness(
...
TEST(MaxPool2dForwardCudaFloat32, MatchesCuDNN_DemandingOddShape)
{
    runCorrectness(
...
TEST(MaxPool2dForwardCudaFloat32, MatchesCuDNN_PaddedStrideOne)
{
    runCorrectness(
...
TEST(MaxPool2dForwardCudaFloat32, MatchesCuDNN_PaddedStrideTwo)
{
    runCorrectness(
...
TEST(MaxPool2dForwardCudaFloat32, BenchmarkAgainstCuDNN_RegularLarge)
{
    runBenchmark(
        "MaxPool2d Forward CUDA Float32 Regular Large",
        options::regular_large::batch_size,
        options::regular_large::channels,
        options::regular_large::input_height,
        options::regular_large::input_width,
...
TEST(MaxPool2dForwardCudaFloat32, BenchmarkAgainstCuDNN_DemandingOddShape)
{
    runBenchmark(
        "MaxPool2d Forward CUDA Float32 Demanding Odd Shape",
        options::demanding_odd_shape::batch_size,
        options::demanding_odd_shape::channels,
        options::demanding_odd_shape::input_height,
        options::demanding_odd_shape::input_width,
...
TEST(MaxPool2dForwardCudaFloat32, BenchmarkAgainstCuDNN_PaddedStrideOne)
{
    runBenchmark(
        "MaxPool2d Forward CUDA Float32 Padded Stride One",
        options::padded_stride_one::batch_size,
        options::padded_stride_one::channels,
        options::padded_stride_one::input_height,
        options::padded_stride_one::input_width,
...
TEST(MaxPool2dForwardCudaFloat32, BenchmarkAgainstCuDNN_PaddedStrideTwo)
{
    runBenchmark(
        "MaxPool2d Forward CUDA Float32 Padded Stride Two",
        options::padded_stride_two::batch_size,
        options::padded_stride_two::channels,
        options::padded_stride_two::input_height,
        options::padded_stride_two::input_width,
