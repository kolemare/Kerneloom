...
namespace kl
{
    ...
    namespace
    {
        ...
        struct MaxPool2dCpuFloat32Task
        {
                    ...
                    for (std::size_t ow = 0; ow < OW; ++ow)
                    {
                        ...
                        for (std::size_t kh = 0; kh < options.kernel_h; ++kh)
                        {
                            ...
                            for (std::size_t kw = 0; kw < options.kernel_w; ++kw)
                            {
                                ...
                                const float value =
                                    input_data[input_row_offset + static_cast<std::size_t>(iw)];
                        ...
                        result_data[result_row_offset + ow] = max_value;
                    }
                }
            }
        };
