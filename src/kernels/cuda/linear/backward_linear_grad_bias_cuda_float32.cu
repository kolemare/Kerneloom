    ...
    namespace
    {
            ...
            const std::uint32_t output_features)
        {
            ...
            if (output < output_features)
            {
                ...
                {
                    sum += grad_output[batch * output_features +
                                       output];
                }
            }
